...
<footer id="footer" class="footer-wrapper scrollspy-stopper <?php echo @$hidden; ?>">
  <div class="container-fluid">
    ...
    <script type="text/javascript" src="<?= $theme_url; ?>assets/js/plugins.js"></script>
    <script type="text/javascript" src="<?= $theme_url; ?>assets/js/custom-multiply-sticky.js"></script>
    <script type="text/javascript" src="<?= $theme_url; ?>assets/js/custom-core.js"></script>
    <?php if (!$is_home): ?>
    ...
    <?php endif; ?>
    <script type="text/javascript" src="<?= $theme_url; ?>assets/js/scripts.js"></script>

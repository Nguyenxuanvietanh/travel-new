...
<html lang="en">
  <head>
    ...
    <!-- CDN URL -->
    <link href="<?=$theme_url ?>assets/css/font-icons.css" rel="stylesheet">
    <link href="<?=$theme_url ?>assets/bootstrap/css/bootstrap.min.css" media="screen" rel="stylesheet" type="text/css">
    <link href="<?=$theme_url ?>assets/css/animate.min.css" rel="stylesheet">
    <link href="<?=$theme_url ?>assets/css/main.css" rel="stylesheet">
    <link href="<?=$theme_url ?>assets/css/plugin.css" rel="stylesheet">
    <link href="<?=$theme_url ?>assets/css/style.css" rel="stylesheet">
    <link href="<?=$theme_url ?>style.css" rel="stylesheet">
    <link href="<?=$theme_url ?>assets/css/mobile.css" rel="stylesheet">
    ...
    <![endif]-->
    <!-- RTL CSS -->
    <script src="<?=$theme_url ?>assets/js/jquery-2.2.4.min.js"></script>
    <?php if($isRTL == "RTL"){ ?>

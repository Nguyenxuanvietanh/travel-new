                            ...
                            <div id="airDatepickerRange-flight" class="row no-gutters mb-15">
                                ...
                                <div class="hidediv col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                            <input id="FlightsDateEnd" autocomplete="false" class="form-control form-readonly-control" placeholder="<?php echo trans('0473'); ?>" name="reture_date" value="<?php echo $search->arrival; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>

                ...
                <div class="d-flex flex-column flex-lg-row sb">
                    ...
                    <div class="o2">
                        ...
                        <p class="location">
                            ...
                            <?php if(!empty($module->mapAddress)){ ?> <small class="hidden-xs">,
                                <?php echo character_limiter($module->mapAddress, 50);?></small>
                            <?php } ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input name="date" type="text"
                                                            class="form-control tourdate form-control-sm"
                                                            placeholder="<?php echo trans('08');?>"
                                                            value="<?php echo $module->date; ?>">
                                                    </div>
                                                    <div class="col-12">
                                                        <button type="submit"
                                                            class="btn btn-block btn-success btn-sm loader mt-5 date"><?php echo trans('0454');?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="hotel-room-sm-item">
                                            <div class="the-room-item">
                                                ...
                                                <div class="d-flex align-items-center adult-Price">
                                                    <h6><?php echo trans('010');?>
                                                        <?php echo $module->currSymbol;?><?php echo $module->perAdultPrice;?>
                                                    </h6>
                                                    <select
                                                        style="min-width:50px;height: 35px !important;min-height: 35px !important;"
                                                        name="adults" class="changeInfo input-sm form-control"
                                                        id="selectedAdults">
                                                        <?php for($adults = 1; $adults <= $module->maxAdults; $adults++){ ?>
                                                        <option value="<?php echo $adults;?>"
                                                            <?php echo makeSelected($selectedAdults, $adults); ?>>
                                                            <?php echo $adults;?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <span
                                                        class="price adultPrice"><?php echo $module->currSymbol;?><?php echo $module->adultPrice;?></span>
                                                </div>
                                            ...
                                            <div class="the-room-item">
                                                ...
                                                <div class="d-flex align-items-center tour-child">
                                                    <h6><?php echo trans('011');?>
                                                        <?php echo $module->currSymbol;?><?php echo $module->perChildPrice;?>
                                                    </h6>
                                                    <select name="child"
                                                        class="selectx changeInfo input-sm form-control"
                                                        id="selectedChild"
                                                        style="height: 35px !important;min-height: 35px !important;">
                                                        <option value="0">0</option>
                                                        <?php for($child = 1; $child <= $module->maxChild; $child++){ ?>
                                                        <option value="<?php echo $child;?>"
                                                            <?php echo makeSelected($selectedChild, $child); ?>>
                                                            <?php echo $child;?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <span
                                                        class="price childPrice"><?php echo $module->currSymbol;?><?php echo $module->childPrice;?></span>
                                                </div>
                                                <!--  <a href="#" class="remove"><i class="fa fa-times"></i></a> -->
                                            </div>
                                            <div class="the-room-item">
                                                ...
                                                <div class="d-flex align-items-center tour-infant">
                                                    <h6><?php echo trans('0282');?>
                                                        <?php echo $module->currSymbol;?><?php echo $module->perInfantPrice;?>
                                                    </h6>
                                                    <select name="infant"
                                                        class="selectx changeInfo input-sm form-control"
                                                        id="selectedInfants"
                                                        ...
                                                        <option value="<?php echo $infant;?>"
                                                            <?php echo makeSelected($selectedInfants, $infant); ?>>
                                                            <?php echo $infant;?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <span
                                                        class="price infantPrice"><?php echo $module->currSymbol;?><?php echo $module->infantPrice;?></span>
                                                </div>
                                                <?php } ?>
                                                <!--  <a href="#" class="remove"><i class="fa fa-times"></i></a> -->
                                            </div>
                                        ...
                                        <div class="hotel-room-sm-item">
                                            <div class="the-hotel-item">
                                                <h4 class="well well-sm text-center strong"
                                                    ...
                                                    <small style="font-size: 12px;"> <?php echo trans('0126');?> <span
                                                            class="totaldeposit"> <?php echo $module->currCode;?>
                                                            <?php echo $module->currSymbol;?><?php echo $module->totalDeposit;?></span>
                                                    </small>
                                                </h4>
                                                <div class="clear"></div>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="map-holder">
                                            <?php  if($appModule == "boats"){
                                                ?>
                                            <iframe id="mapframe" width="100%" height="558"
                                                style="position: static; background: #eee;"
                                                src="<?php echo base_url();?>boats/boatmap/<?php echo $module->id; ?>"
                                                frameborder="0"></iframe>
                                            <script>
                                                // $('#collapseMap').on('shown.bs.collapse', function(e){
                                                jQuery(function ($) {
                                                    $("#mapframe").prop("src", "<?php echo base_url();?>boats/boatmap/<?php echo $module->id; ?>");
                                                });
                                            </script>
                                            <?php }else{ ?>
                                ...
                                <div class="feature-row">
                                    <div class="row gap-10 gap-md-30">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <p class="go-text-left"><i class="fa fa-sun-o text-success"></i> <strong>
                                                    <?php echo trans('0275');?> </strong> :
                                                <?php echo $module->boatDays;?> | <i
                                                    class="fa fa-moon-o text-warning"></i> <strong>
                                                    <?php echo trans('0276');?> </strong> :
                                                <?php echo $module->boatNights;?> | <i
                                                    class="fa fa-moon-o text-warning"></i> <strong>
                                                    <?php echo trans('0441');?> </strong> :
                                                <?php echo $module->boathours;?> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="INCLUSIONS">
                                        ...
                                        <ul class="list_ok col-md-12" style="margin: 0 0 5px 0;">
                                            <li class=""><i class="fas fa-check-circle text-primary"></i>
                                                &nbsp;&nbsp;&nbsp; <?php echo $inclusion->name; ?></li>
                                        </ul>
                                        <?php } } ?>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="col-md-6" id="EXCLUSIONS">
                                        ...
                                        <ul class="col-md-12" style="margin: 0 0 5px 0;list-style:none;">
                                            <li class=""><i class="fas fa-times-circle text-primary"></i>
                                                &nbsp;&nbsp;&nbsp; <?php echo $exclusion->name; ?> &nbsp;&nbsp;&nbsp;
                                            </li>
                                        </ul>
                                        <?php } } ?>
                                        <div class="clearfix"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <button data-toggle="collapse" type="button"
                                class="writeReview btn btn-primary btn-block mb-10" sdata-target="#ADDREVIEW"
                                href="#ADDREVIEW" aria-controls="#ADDREVIEW"><i class="icon_set_1_icon-68"></i>
                                <?php echo trans('083');?></button>
                            <div class="collapse mt-20" id="ADDREVIEW">
                                <div class="card card-body row">
                                    <form class="form-horizontal row" method="POST"
                                        id="reviews-form-<?php echo $module->id;?>" action="" onsubmit="return false;">
                                        ...
                                        <div class="col-md-4 go-right">
                                            <div class="card card-body card-light">
                                                <h3 class="text-center">
                                                    <strong><?php echo trans('0389');?></strong>&nbsp;<span
                                                        id="avgall_<?php echo $module->id; ?>"> 1</span> / 10</h3>
                                                <div class="row">
                                                    <div class="col-md-6 form-horizontal">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo trans('030');?></label>
                                                            <select
                                                                class="input-sm form-control reviewscore reviewscore_<?php echo $module->id; ?>"
                                                                id="<?php echo $module->id; ?>" name="reviews_clean">
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo trans('031');?></label>
                                                            <select
                                                                class="input-sm form-control reviewscore reviewscore_<?php echo $module->id; ?>"
                                                                id="<?php echo $module->id; ?>" name="reviews_comfort">
                                                                <option value="1"> 1 </option>
                                                                <option value="2"> 2 </option>
                                                                <option value="3"> 3 </option>
                                                                <option value="4"> 4 </option>
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo trans('032');?></label>
                                                            <select
                                                                class="input-sm form-control reviewscore reviewscore_<?php echo $module->id; ?>"
                                                                id="<?php echo $module->id; ?>" name="reviews_location">
                                                                <option value="1"> 1 </option>
                                                                <option value="2"> 2 </option>
                                                                <option value="3"> 3 </option>
                                                                <option value="4"> 4 </option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo trans('033');?></label>
                                                            <select
                                                                class="input-sm form-control reviewscore reviewscore_<?php echo $module->id; ?>"
                                                                id="<?php echo $module->id; ?>"
                                                                name="reviews_facilities">
                                                                <option value="1"> 1 </option>
                                                                <option value="2"> 2 </option>
                                                                <option value="3"> 3 </option>
                                                                <option value="4"> 4 </option>
                                                        ...
                                                        <input type="hidden" id="loggedin"
                                                            value="<?php echo $usersession;?>" />
                                                        <input type="hidden" id="itemid"
                                                            value="<?php echo $module->id; ?>" />
                                                        <input type="hidden" id="module"
                                                            value="<?php echo $appModule;?>" />
                                                        <input type="hidden" id="addtxt"
                                                            value="<?php echo trans('029');?>" />
                                                        <input type="hidden" id="removetxt"
                                                            value="<?php echo trans('028');?>" />
                                                        <div class="form-group">

                                                            <label
                                                                class="control-label"><?php echo trans('034');?></label>
                                                            <select
                                                                class="input-sm form-control reviewscore reviewscore_<?php echo $module->id; ?>"
                                                                id="<?php echo $module->id; ?>" name="reviews_staff">
                                                                <option value="1"> 1 </option>
                                                                <option value="2"> 2 </option>
                                                                <option value="3"> 3 </option>
                                                                <option value="4"> 4 </option>
                                        ...
                                        <div class="col-md-<?php echo $mdCol;?>">
                                            ...
                                            <textarea class="form-control" type="text"
                                                placeholder="<?php echo trans('0391');?>" name="reviews_comments" id=""
                                                cols="30" rows="10"></textarea>
                                            <div class="form-group"></div>
                                            <p class="text-danger"><strong><?php echo trans('0371');?></strong> :
                                                <?php echo trans('085');?></p>
                                            <input type="hidden" name="addreview" value="1" />
                                            <input type="hidden" name="overall" id="overall_<?php echo $module->id; ?>"
                                                value="1" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        id="<?php echo $module->id; ?>"><?php echo trans('086');?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <?php $currenturl = current_url(); $wishlist = pt_check_wishlist($customerloggedin,$module->id);
                                if($allowreg){
                                    if($wishlist){ ?>
                            <span class="btn wish btn-danger btn-outline removewishlist btn-block"><span
                                    class="wishtext"><i class=" icon_set_1_icon-82"></i>
                                    <?php echo trans('028');?></span></span>
                            <?php }else{ ?>
                            <span class="btn wish addwishlist btn-danger btn-outline btn-block"><span
                                    class="wishtext"><i class=" icon_set_1_icon-82"></i>
                                    <?php echo trans('029');?></span></span>

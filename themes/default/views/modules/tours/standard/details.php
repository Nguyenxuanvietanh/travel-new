                ...
                <div class="container">
                    <div class="fullwidth-horizon-sticky-item clearfix">
                        <ul id="horizon-sticky-nav" class="horizon-sticky-nav clearfix">
                            ...
                            <li>
                                <a href="#packages"><?php echo trans('Viator');?></a>
                            </li>
                            <!--<li>
                    ...
                    <p>
                      <?php echo $specialCheckInInstructions; ?>
                        ...
                        <?php } ?>
                            ...
                            <h3 class="heading-title"><span><?=lang('0278')?> <?=lang('Viator')?></span></h3>
                                ...
                                <div class="feature-row">
                                    <div class="row gap-10 gap-md-30">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <p class="go-text-left"><i class="fa fa-sun-o text-success"></i> <strong> <?php echo trans('0275');?> </strong> :   <?php echo $module->tourDays;?> | <i class="fa fa-moon-o text-warning"></i>   <strong> <?php echo trans('0276');?> </strong> :  <?php echo $module->tourNights;?>  | <i class="fa fa-moon-o text-warning"></i>   <strong> <?php echo trans('0441');?> </strong> :  <?php echo $module->tourhours;?> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $("#send_enquery").submit(function (e) {
        ...
        $.ajax({
            url: '<?=base_url('tours/do_tours_guest_booking')?>',
            type: 'post',

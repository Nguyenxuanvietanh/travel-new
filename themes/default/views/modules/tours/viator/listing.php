                                    ...
                                    <?php if(!empty($results->data)){ ?>
                                        <?php foreach($results->data as $item){ ?>
                                            ...
                                            <div class="product-long-item">
                                                <form action="<?php echo base_url()?>packages/detail/<?php echo str_replace(" ","-", $item->data->title);?>" method="post" role="search">
                                                    <div class="row equal-height shrink-auto-md gap-15">
                                                        <div class="col-12 col-shrink">
                                                            <div class="image">
                                                                <img src="<?php echo $item->data->thumbnailHiResURL;?>" alt="<?php echo character_limiter($item->title,20);?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-auto">
                                                            <div class="col-inner d-flex flex-column">
                                                                <div class="content-top">
                                                                    <div class="d-flex">
                                                                        <div>
                                                                            ...
                                                                            <h5><a href="" class="code"><?php echo character_limiter($item->data->title,20);?></a></h5>
                                                                            <p class="location"><i class="fas fa-map-marker-alt "></i><a  href=""><?php echo character_limiter($item->data->primaryDestinationName,10);?></a></p>
                                                                        </div>
                                                                ...
                                                                <div class="content">
                                                                    <?php echo strip_tags(character_limiter($item->data->shortDescription,150));?>
                                                                </div>

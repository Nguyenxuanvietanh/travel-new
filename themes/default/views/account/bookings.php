...
<!-- Hotelston  -->
<?php
if(isset($HotelstonBookings) && !empty($HotelstonBookings)){
    foreach ($HotelstonBookings as $HotBookings){
        ?>
        <div class="row">

            <div class="col-md-5 offset-0 o4">

                <img alt="" class="go-right img-responsive" style="max-width:96px;padding:5px" src="<?php echo $HotBookings->images;?>">
                <div class="d-flex flex-column">
                    <div class="rating-item go-text-right"><?php echo $HotBookings->stars;?></div>
                    <a class="dark RTL go-text-right" href="#"><b><?php echo $HotBookings->company_name; ?></b></a>

                    <span class="go-text-right"><?php echo $HotBookings->location;?></span>
                    <span class="opensans green bold size14  text-success go-text-right"><strong><small><?php echo $HotBookings->currency;?> <?php echo $HotBookings->price;?></strong></span>
                    <small><span class="grey go-right"><?php echo $HotBookings->checkIn;?></span></small>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-3 o3 go-text-right">
        <span class="grey">
        <strong><?php echo trans('0145');?> <?php echo trans('021');?></strong> <?php echo $HotBookings->id;?><br>
        <strong><?php echo trans('0398');?> </strong> <?php echo $HotBookings->agentReferenceNumber;?> <br>
        <strong><?php echo trans('079');?> </strong> <?php echo $HotBookings->checkOut;?> <br>
        </span>
            </div>
            <div class="col-md-2 o2">
                <h5 class="mt0 float-none"><strong>
                        <?php if($HotBookings->status == "paid"){ ?>
                            <span class="alert alert-success btn-block text-center"><?php echo trans('081');?></span>
                        <?php }elseif($HotBookings->status == "cancelled"){ ?>
                            <span class="alert alert-warning btn-block text-center"><?php echo trans('0347'); ?></span>
                        <?php }elseif($HotBookings->status == "reserved"){ ?>
            ...
            <div class="col-md-2 offset-0 o1">
                <a style="margin-bottom:5px" href="<?php echo base_url();?>hotelst/invoice/<?php echo $HotBookings->id;?>" target="_blank" class="btn btn-primary btn-action btn-block"><?php echo trans('076');?></a>
                <div class="clearfix"></div>

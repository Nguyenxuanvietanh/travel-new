...
defined('SHOW_DEBUG_BACKTRACE') OR define('SHOW_DEBUG_BACKTRACE', TRUE);
    ...
    define('PT_VERSION', 'v7.4');
    define('PT_LINK', 'http://phptravels.com');
    define('PT_SHOW', '1');
    define('PT_STARS_ICON', "<i class='rating-icon fa fa-star rating-rated'></i>");
    define('PT_EMPTY_STARS_ICON', "<i class='rating-symbol-background rating-icon far fa-star'></i>");

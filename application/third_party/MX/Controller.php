    ...
    public function __construct()
    {
        ...
        foreach ($this->data['modulesList'] as $index => $module) {
            if ($module->ia_active == 1 && $module->parent_id == 'hotels') {
                ...
                $namestore = array('link' => 'hotels', 'foldername' => 'hotels', 'name' => '0616', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
            ...
            if ($module->ia_active == 1 && $module->parent_id == 'flights') {
                ...
                array_push($ordernumber, $module->order);
                $namestore = array('link' => 'flights', 'foldername' => 'flights', 'name' => '0564', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                array_push($modulesname, $namestore);
            }
            if ($module->ia_active == 1 && $module->parent_id == 'tours') {
                ...
                array_push($ordernumber, $module->order);
                $namestore = array('link' => 'tours', 'foldername' => 'tours/' . $modulename . '', 'name' => '0279', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                array_push($modulesname, $namestore);
            }
            if ($module->ia_active == 1 && $module->parent_id == 'visa') {
                ...
                array_push($ordernumber, $module->order);
                $namestore = array('link' => 'visa', 'foldername' => 'visa', 'name' => '0577', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                array_push($modulesname, $namestore);
            }
            if ($module->ia_active == 1 && $module->parent_id == 'cars') {
                ...
                array_push($ordernumber, $module->order);
                $namestore = array('link' => 'cars', 'foldername' => 'cars/' . $modulename . '', 'name' => '0617', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                array_push($modulesname, $namestore);
            }


            if ($module->ia_active == 1 && $module->parent_id == 'extra') {
                if ($module->name == 'Rentals') {
                    $modulename = $module->name;
                    array_push($ordernumber, $module->order);
                    $namestore = array('link' => 'rentals', 'foldername' => 'rentals', 'name' => '0630', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                    array_push($modulesname, $namestore);
                }
            }
            ...
            if ($module->ia_active == 1 && $module->parent_id == 'extra') {
                if ($module->name == 'Boats') {
                    $modulename = $module->name;
                    array_push($ordernumber, $module->order);
                    $namestore = array('link' => 'boats', 'foldername' => 'boats', 'name' => '0633', 'order' => $module->order, 'slug' => $module->slug, 'module_name' => $modulename);
                    array_push($modulesname, $namestore);
                }
            }

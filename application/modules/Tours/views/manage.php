...
<form class="form-horizontal tour-form row" method="POST" action="" enctype="multipart/form-data"
        ...
        <div class="tab-content form-horizontal">
          <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                <input class="form-control" type="text" placeholder="Tour Name" name="tourname"
                  value="<?php echo $tdata[0]->tour_title;?>">
              </div>
            </div>
            <div class="row form-group">
                  ...
                  <tbody>
                    ...
                    <tr bgcolor="#ffffff" style="text-align:center">
                      ...
                      <td><input type="text" class="form-control input-sm adult" name="maxadult"
                          <?php echo $adultStatus;?> id="" size="" value="<?php echo @$tdata[0]->tour_max_adults;?>">
                      </td>
                      <td><input type="text" class="form-control input-sm child" name="maxchild"
                          <?php echo $childStatus;?> id="" size="" value="<?php echo @$tdata[0]->tour_max_child;?>">
                      </td>
                      <td><input type="text" class="form-control input-sm infant" name="maxinfant"
                          <?php echo $infantStatus;?> id="" size="" value="<?php echo @$tdata[0]->tour_max_infant;?>">
                      </td>
                    </tr>
                    <tr bgcolor="#ffffff" style="text-align:center">
                      <td>Price</td>
                      <td><input type="text" class="form-control input-sm adult" <?php echo $adultStatus;?>
                          name="adultprice" id="" size="" value="<?php echo @$tdata[0]->tour_adult_price;?>"></td>
                      <td><input type="text" class="form-control input-sm child" <?php echo $childStatus;?>
                          name="childprice" id="" size="" value="<?php echo @$tdata[0]->tour_child_price;?>"></td>
                      <td><input type="text" class="form-control input-sm infant" <?php echo $infantStatus;?>
                          name="infantprice" id="" size="" value="<?php echo @$tdata[0]->tour_infant_price;?>"></td>
                    </tr>
                    <tr bgcolor="#ffffff" style="text-align:center">
                      <td>Enable</td>
                      <td>
                        <?php if(empty($adultStatus)){ ?>
                        <span class="btn btn-danger btn-xs disabledinput btn-block" id="adult"><span
                            id="adultbtn">Disable</span></span>
                        <?php }else{ ?>
                        <span class="btn btn-xs enabledinput btn-success btn-block" id="adult"><span
                            id="adultbtn">Enable</span></span>
                        <?php } ?>
                      </td>
                      <td>
                        <?php if(empty($childStatus)){ ?>
                        <span class="btn btn-xs disabledinput btn-danger btn-block" id="child"><span
                            id="childbtn">Disable</span> </span>
                        <?php }else{ ?>
                        <span class="btn btn-success btn-xs enabledinput btn-block" id="child"><span
                            id="childbtn">Enable</span> </span>
                        <?php } ?>
                      </td>
                      <td>
                        <?php if(empty($infantStatus)){ ?>
                        <span class="btn btn-xs disabledinput btn-danger btn-block" id="infant"><span
                            id="infantbtn">Disable</span> </span>
                        <?php }else{ ?>
                        <span class="btn btn-success btn-xs enabledinput btn-block" id="infant"><span
                            id="infantbtn">Enable</span> </span>
                        <?php } ?>
                      </td>
                    </tr>
                  </tbody>
                ...
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      ...
                      <input type="hidden" name="locations[]" id="locationid<?php echo $i;?>" required=""
                        value="<?php echo @$tourlocations[$i]->id; ?>">
                      <button id="" data-index='<?php echo $i;?>' class="btn btn-danger btn-xs reset"
                        style="position: absolute; height: 34px; margin-left: 4px;"><i class="fa fa-times"></i></button>
                    </div>
                    <div class="clearfix"></div>
                    <br>
                  </div>
                ...
                <div class="col-md-12 form-horizontal">
                  <table class="table">
                    <tr>
                      ...
                      <td>
                        <input type="text" class="form-control Places" id="mapaddress" name="tourmapaddress"
                          value="<?php echo $tdata[0]->tour_mapaddress;?>">
                      </td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td><input type="text" class="form-control" id="latitude"
                          value="<?php echo $tdata[0]->tour_latitude;?>" name="latitude" /></td>
                    </tr>
                    <tr>
                      <td>Longitude</td>
                      <td><input type="text" class="form-control" id="longitude"
                          value="<?php echo $tdata[0]->tour_longitude;?>" name="longitude" /></td>
                    </tr>
                  </table>
                </div>
                <div class="col-md-12">
          ...
          <div class="tab-pane wow fadeIn animated in" id="INCLUSIONS">
            <div class="row form-group">
              <div class="col-md-12">
                <div class="col-md-4">
                  <label class="pointer"><input class="all" type="checkbox" name="" value="" id="select_all"> Select
                    All</label>
                </div>
                <div class="clearfix"></div>
                <hr>
                ...
                <div class="col-md-4">
                  <label class="pointer"><input class="checkboxcls"
                      <?php if($submittype == "add"){ if( $ti->sett_selected == "Yes"){echo "checked";} }else{ if(in_array($ti->sett_id,$inclusions)){ echo "checked"; } } ?>
                      type="checkbox" name="touramenities[]" value="<?php echo $ti->sett_id;?>">
                    <?php echo $ti->sett_name;?></label>
                </div>
                <?php } ?>
              </div>
            </div>
          ...
          <div class="tab-pane wow fadeIn animated in" id="EXCLUSIONS">
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <label class="pointer"><input class="checkboxcls"
                      <?php if($submittype == "add"){ if( $te->sett_selected == "Yes"){echo "checked";} }else{ if(in_array($te->sett_id,$exclusions)){ echo "checked"; } } ?>
                      type="checkbox" name="tourexclusions[]" value="<?php echo $te->sett_id;?>">
                    <?php echo $te->sett_name;?></label>
                </div>
                <?php } ?>
              </div>
            </div>
          ...
          <div class="tab-pane wow fadeIn animated in" id="META_INFO">
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <input class="form-control" type="text" placeholder="Meta title" name="tourmetatitle"
                  value="<?php echo $tdata[0]->tour_meta_title;?>">
              </div>
            </div>
            <div class="row form-group">
              <label class="col-md-3 control-label text-left">Meta Keywords</label>
              <div class="col-md-9">
                <input class="form-control" type="text" placeholder="Meta keywords" name="tourkeywords"
                  value="<?php echo $tdata[0]->tour_meta_keywords;?>">
              </div>
            </div>
            <div class="row form-group">
              <label class="col-md-3 control-label text-left">Meta Description</label>
              <div class="col-md-9">
                <textarea class="form-control" placeholder="Meta description here..." name="tourmetadesc"
                  rows="5"><?php echo $tdata[0]->tour_meta_desc;?></textarea>
              </div>
            </div>
          </div>
          <div class="tab-pane wow fadeIn animated in" id="POLICY">
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <select multiple class="chosen-multi-select" name="tourpayments[]">
                  ...
                  <option value="<?php echo $tp->sett_id;?>"
                    <?php if($submittype == "add"){ if( $tip->sett_selected == "Yes"){echo "selected";} }else{ if(in_array($tp->sett_id,$tpayments)){ echo "selected"; } } ?>>
                    <?php echo $tp->sett_name;?></option>
                  <?php  } } ?>
                </select>
              </div>
            </div>
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" placeholder="Privacy Policy..." name="tourprivacy"
                  rows="3"><?php echo $tdata[0]->tour_privacy;?> </textarea>
              </div>
            </div>
          </div>
          <div class="tab-pane wow fadeIn animated in" id="CONTACT">
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <input class="form-control" type="email" placeholder="Tour's Email" name="touremail"
                  value="<?php echo $tdata[0]->tour_email;?>">
              </div>
            </div>
            <div class="row form-group">
              <label class="col-md-3 control-label text-left">Operator's Website</label>
              <div class="col-md-9">
                <input name="tourwebsite" type="text" placeholder="Website" class="form-control "
                  value="<?php echo @$tdata[0]->tour_website;?>" />
              </div>
            </div>
            <div class="row form-group">
              <label class="col-md-3 control-label text-left">Operator's Phone</label>
              <div class="col-md-9">
                <input name="tourphone" type="text" placeholder="Phone" class="form-control"
                  value="<?php echo @$tdata[0]->tour_phone;?>" />
              </div>
            </div>
            <div class="row form-group">
              <label class="col-md-3 control-label text-left">Operator's Full Address</label>
              <div class="col-md-9">
                <input name="tourfulladdress" type="text" placeholder="Address" class="form-control"
                  value="<?php echo @$tdata[0]->tour_fulladdress;?>" />
              </div>
            </div>
          </div>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row form-group">
                  ...
                  <div class="col-md-10">
                    <input name='<?php echo "translated[$lang][title]"; ?>' type="text" placeholder="Tour Name"
  ...
  <div class="col-md-4 sticky">
    <div class="panel panel-default">
      ...
      <div id="setting_form" class="panel-body">
        <div class="row form-group">
          <label class="col-md-3 control-label text-left">Type</label>
          <div class="col-md-9">
            <select id="type" class="form-control" name="type">
              <?php foreach($tour_types as $type){?>
                <option value="<?php echo $type->id;?>" <?php if($type->id == $tdata[0]->type ){echo "selected";} ?> ><?php echo $type->name;?></option>
              <?php } ?>
            </select>
          </div>
        </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            <select class="form-control" name="tourstars">
              ...
              <option value="<?php echo $stars;?>" <?php if($stars == $tdata[0]->tour_stars ){echo "selected";} ?>>
                <?php echo $stars;?></option>
              <?php   } ?>
            </select>
          </div>
          <?php }else{ ?>
        ...
        <div class="row form-group">
          <label class="col-md-3 control-label text-left">Tour Hours</label>
          <div class="col-md-9">
            <input type="text" class="form-control" name="tourhours" value="<?php echo @$tdata[0]->tour_hours; ?>">
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-3 control-label text-left">Tour Days</label>
          <div class="col-md-9">
            <input type="text" class="form-control" name="tourdays" value="<?php echo @$tdata[0]->tour_days; ?>">
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-3 control-label text-left">Tour Nights</label>
          <div class="col-md-9">
            <input type="text" class="form-control" name="tournights" value="<?php echo @$tdata[0]->tour_nights; ?>">
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-3 control-label text-left">Tour Type</label>
          <div class="col-md-9">
            <select class="chosen-select" name="tourtype">
              <option value="">Select</option>
              <?php if(!empty($tourtypes)){
                  foreach($tourtypes as $tt){ ?>
              <option value="<?php echo $tt->sett_id;?>"
                <?php if($tdata[0]->tour_type ==  $tt->sett_id ){echo "selected";} ?>><?php echo $tt->sett_name;?>
              </option>
              <?php  } } ?>
            </select>
          </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-3">
            <select Placeholder="No" class="form-control" Placeholder="No" name="isfeatured" id="isfeatured"
              onchange="changecollapse(this.options[this.selectedIndex].value,'Featured')">
          ...
          <div class="col-md-6" style="margin-left:-15px">
            <div class="row">
              <div class="col-md-6">
                <div class="row">
                  <input class="form-control dpd1" type="text" placeholder="From"
                    value="<?php if(empty($tdata[0]->tour_featured_forever)){ echo pt_show_date_php($tdata[0]->tour_featured_from);}?>"
                    name="ffrom">
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <input class="form-control dpd2" type="text" placeholder="To"
                    value="<?php if(empty($tdata[0]->tour_featured_forever)){ echo pt_show_date_php($tdata[0]->tour_featured_to);}?>"
                    name="fto">
                </div>
              </div>
            </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-5">
            ...
            <select name="deposittype" class="form-control">
              ...
              <option value="percentage" <?php if($tourdeposittype == "percentage"){ echo "selected";} ?> selected>
                Percentage</option>
            </select>
            <?php }else{ ?><input type="text" class="form-control" name="deposittype"
              value="<?php echo $tourdeposittype; ?>" readonly="readonly"><?php } ?>
          </div>
          <div class="col-md-4">
            <input type="text" class="form-control" id="" placeholder="" name="depositvalue"
              value="<?php echo $tourdepositval; ?>" <?php if(!$isadmin){ echo "readonly"; } ?>>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-5">
            <select name="taxtype" class="form-control">
              ...
              <option value="percentage" <?php if($tourtaxtype == "percentage"){ echo "selected";} ?>>Percentage
              </option>
            </select>
          </div>
          <div class="col-md-4">
            <input class="form-control" id="" Placeholder="" type="text" name="taxvalue"
              value="<?php echo $tourtaxval; ?>" />
          </div>
        </div>
        <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
          <label class="col-md-3 control-label text-left">Related Tours</label>
          <div class="col-md-9">
            <select multiple class="chosen-multi-select" name="relatedtours[]">
              ...
              <option value="<?php echo $t->tour_id;?>"
                <?php if(in_array($t->tour_id,$tourrelated)){echo "selected";} ?>><?php echo $t->tour_title;?></option>
              <?php endforeach; } ?>
            </select>
          </div>
        </div>
...
<script>
  ...
  $('select#type').change(function(){
    $('#golf_holes, #golf_locations, #golf_time').remove()
    if($(this).val() != 1){
      addSelect()
    }
  });
  ...
  function addSelect(){
    $('select#type').parent().parent().after(`
        <div id="golf_holes" class="row form-group">
            <label class="col-md-3 control-label text-left">Holes</label>
            <div class="col-md-9">
              <select id="golf_hole" class="form-control" name="golf_hole">
                <?php foreach($golf_holes as $hole){?>
                  <option value="<?php echo $hole->id;?>" <?php if($hole->id == $tdata[0]->golf_hole_id ){echo "selected";} ?> ><?php echo $hole->hole;?></option>
                <?php } ?>
              </select>
            </div>
          </div>

          <div id="golf_locations" class="row form-group">
            <label class="col-md-3 control-label text-left">Locations</label>
            <div class="col-md-9">
              <select id="golf_location" class="form-control" name="golf_location">
                <?php foreach($golf_locations as $location){?>
                  <option value="<?php echo $location->id;?>" <?php if($location->id == $tdata[0]->golf_location_id ){echo "selected";} ?> ><?php echo $location->location;?></option>
                <?php } ?>
              </select>
            </div>
          </div>

          <div id="golf_time" class="row form-group">
            <label class="col-md-3 control-label text-left">Time</label>
            <div class="col-md-9">
              <select id="golf_time" class="form-control" name="golf_time">
                <?php foreach($golf_times as $time){?>
                  <option value="<?php echo $time->id;?>" <?php if($time->id == $tdata[0]->golf_time_id ){echo "selected";} ?> ><?php echo $time->time;?></option>
                <?php } ?>
              </select>
            </div>
          </div>
...
<script
  src="https://maps.googleapis.com/maps/api/js?key=<?php echo $appSettings->mapApi; ?>&libraries=places&callback=initAutocomplete"
  async defer></script>
<!-- Google Places -->
<script>

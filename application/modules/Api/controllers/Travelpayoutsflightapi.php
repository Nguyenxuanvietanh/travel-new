    ...
    public function search_post(){
       ...
       $booking_link =  'http://misc.travelpayouts.com/flights/redirect/'.$token;
        ...
        if($triptypename != 'round' ) {
            $sing = md5('host=loaclhost&locale=en&marker='.$this->config->marker_id.'&adults='.$adult.'&children='.$children.'&infants='.$infant.'&date='.$departureDate.'&destination='.$destination.'&origin='.$orgin.'&trip_class='.$class_trip.'&user_ip=110.36.223.2');
            ...
            $sing =  md5('host=loaclhost&locale=en&marker='.$this->config->marker_id.'&adults='.$adult.'&children='.$children.'&infants='.$infant.'&date='.$departureDate.'&destination='.$destination.'&origin='.$orgin.'&date='.$return_date.'&destination='.$destination.'&origin='.$orgin.'&trip_class='.$class_trip.'&user_ip=110.36.223.2');
            $segments = array((object)[
                "origin"         => $orgin,
                "destination"        => $destination,
                "date"         => $departureDate

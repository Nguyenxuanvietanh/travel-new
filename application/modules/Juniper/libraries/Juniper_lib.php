...
class Juniper_lib {
    ...
    public function getdetail($code,$RatePlanCode,$data,$search)
    {
        ...
        try {
            ...
            $client->__setLocation("https://xml-uat.bookingengine.es/WebService/jp/operations/checktransactions.asmx");
    ...
    public function booking($payload,$data)
    {
        ...
        try {
            ...
            $client->__setLocation("https://xml-uat.bookingengine.es/webservice/jp/operations/booktransactions.asmx");

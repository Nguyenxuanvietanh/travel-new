  ...
  <div class="panel panel-primary">
    ...
    <div class="tabbable tabs-left">
      <ul class="nav nav-tabs" style="height:850px;background-color:#F2F2F2;margin-top:5px;margin-bottom:0px">
        ...
        <li class="<?php if($ldir == $lang){ echo "active"; } ?>"><a href="<?php echo base_url()."admin/pass/translate/".$slug."/".$ldir;?>"><img src="<?php echo PT_LANGUAGE_IMAGES.$ldir.".png";?>" style="width:30px;height:25px" alt="" /> <?php echo $lname; ?></a></li>
        <?php } } ?>
      </ul>

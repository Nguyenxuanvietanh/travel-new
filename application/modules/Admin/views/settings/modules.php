...
foreach($array as $key => $item){?>
 <div class="col-md-4 pull-left col-xs-12" style="margin-bottom:25px; height:450px">
...
<style>
 ...
 /*============================================================================================*/
    ...
    input[type="checkbox"]{top:0px;margin:0px 5px;-webkit-appearance:none;-moz-appearance:none;appearance:none;width:2.2rem;height:2.2rem;position:relative;cursor:pointer}

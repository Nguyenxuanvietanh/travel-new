    ...
    <div class="modal-body">
      <div class="form text-left">
        <div class="row form-group justify-content-center align-items-center">
          <label for="form-input" class="hidden-xs col-md-2 col-lg-1 control-label text-left" style="padding: 5px; font-size: 24px;"><?php echo trans('0154');?></label>
          <div class="col-sm-12 col-md-6 ">
            <select class="form-control form chosen-the-basic" name="gateway" id="gateway">

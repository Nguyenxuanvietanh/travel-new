            ...
            <div class="col-12 col-lg-4 order-lg-last">
              ...
              <aside class="sidebar-wrapper pt-30 pb-30 bg-white-shadow">
                <a href="#" class="product-small-item">
                  ...
                  <div class="content">
                    <div class="content-body">
                      ...
                      <div class="clear"></div>
                      <span class="meta text-muted go-right"><i class="ion-location text-info"></i> <?php echo $invoice->location;?></span>
                    <div class="clear"></div>
                    </div>
                  </div>
                </a>
                ...
                <ul class="confirmation-list">
                  <li>
                    <span class="font-weight-bold go-right"><?php echo trans("060");?> <?php echo $invoice->nights;?></span>
                  ...
                  <li>
                    <span class="font-weight-bold go-right"><?php echo trans('0428');?> <?php echo $invoice->extraBeds; ?>:</span>
                    <span class="go-left"> <?php echo $invoice->currSymbol; ?><?php echo $invoice->extraBedsCharges; ?></span>
                  <div class="clear"></div>
                  </li>
                  <?php } ?>
                  <li>
                    ...
                    <span class="go-left float-right"> <?php echo $invoice->currCode; ?> <?php echo $invoice->currSymbol; ?><?php echo str_replace(".00","",number_format($invoice->checkoutAmount,2)); ?></span>
                  </li>
                  <div class="clear"></div>
                  <li class="mt-20">
                    <span class="font-weight-bold go-right rtl-w-100"><?=lang('0153')?></span>
                    <span class="go-left float-right"><?php echo $invoice->currCode; ?> <?php echo $invoice->currSymbol; ?><?php echo str_replace(".00","",number_format($invoice->tax,2));?></span>
                  <div class="clear"></div>
                  </li>
                  <li class="total">
                    <span class="font-weight-bold go-right"><?=lang('0124')?></span>
                    <span class="text-main text-secondary float-right go-left"><?php echo $invoice->currCode; ?> <?php echo $invoice->currSymbol; ?><?php echo str_replace(".00","",number_format($invoice->checkoutTotal,2));?></span>
                  <div class="clear"></div>
                  </li>
                </ul>
              </aside>
              ...
              <aside class="sidebar-wrapper pt-30 pb-30 bg-white-shadow">
                ...
                <ul class="confirmation-list">
                  <li class="clearfix">
                    <span class="font-weight-bold"><?php echo trans('010');?>  <?php echo $invoice->subItem->adults->count;?> <?php echo $invoice->currCode; ?> / <?php echo $invoice->currSymbol;?> <?php echo str_replace(".00",'',number_format($invoice->subItem->adults->price,2));?>:</span>
                  ...
                  <li class="clearfix">
                    <span class="font-weight-bold"><?php echo trans('011');?>  <?php echo $invoice->subItem->child->count;?> / <?php echo $invoice->currCode; ?> <?php echo $invoice->currSymbol;?><?php echo $invoice->subItem->child->price;?>:</span>
                  ...
                  <li class="clearfix">
                    <span class="font-weight-bold"><?php echo trans('0282');?>   <?php echo $invoice->subItem->infant->count;?> / <?php echo $invoice->currCode; ?> <?php echo $invoice->currSymbol;?><?php echo $invoice->subItem->infant->price;?>:</span>
